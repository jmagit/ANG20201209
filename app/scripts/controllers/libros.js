angular.module('cursoApp').factory('LibrosDAO', ['$http', 'URLApi', function ($http, URLApi) {
  var baseUrl = URLApi + 'libros';
  var config = {};
  return {
    query: function () {
...
angular.module('cursoApp').controller('LibrosController',
  ['$log', '$scope', '$window', '$routeParams', '$location', 'LibrosDAO', 'NotificationService',
    function ($log, $scope, $window, $routeParams, $location, dao, notify) {
      var vm = this;
      var idOriginal = null;
      var urlListado = '/libros';
